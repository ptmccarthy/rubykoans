...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # Inject combines the items of a collection using a binary operation
  ...
  #
  # The first way doesn't store the file in memory, it just iterates
  #   through the file as a collection of lines doing some code on each line
